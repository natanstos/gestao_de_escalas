...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {view === "settings" && <SettingsPage settings={churchSettings} setSettings={setChurchSettings} stations={stations} setStations={setStations} eventTypes={eventTypes} setEventTypes={setEventTypes} announce={announce}/>}
    </main>
...
function SettingsPage({ settings, setSettings, stations, setStations, eventTypes, setEventTypes, announce }: { settings: { name: string; timezone: string }; setSettings: React.Dispatch<React.SetStateAction<{ name: string; timezone: string }>>; stations: StationItem[]; setStations: React.Dispatch<React.SetStateAction<StationItem[]>>; eventTypes: EventTypeItem[]; setEventTypes: React.Dispatch<React.SetStateAction<EventTypeItem[]>>; announce: (m: string) => void }) {
